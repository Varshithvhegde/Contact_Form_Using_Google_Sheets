...
5. For detailed explanation on how to use this repository, check out [this blog post](https://www.alexkras.com/how-to-create-a-contact-form-using-google-sheets/)